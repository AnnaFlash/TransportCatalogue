...
namespace transport_catalogue {
	...
	public:
		...
		void AddBus(const std::string_view bus, std::vector<std::string_view> stops, bool is_round);
		...
		void GetBuses(std::vector<Bus>& answer) const;
		void GetStops(std::vector<Stop>& answer) const;
